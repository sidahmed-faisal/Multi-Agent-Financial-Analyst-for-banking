...
def process_earnings_presentation(pdf_path):
    ...
    9. FORMATTING FOR FINANCIAL DATA:
       ...
       - pay attention to small details like arrows indicating growth or decline
       - pay attention to notes on charts and references to data sources or methodologies
